...
const submitOrder = async () => {
  ...
  //  Bersihkan item dari cart agar aman disimpan ke Firebase
  const cleanedItems = cartStore.cartItems
  ...
  if (!cleanedItems.length) {
    alert('Your cart is empty or contains invalid products.')
    loading.value = false
    return
  }
  ...
  const orderData = {
    ...
    items: cleanedItems, // Sudah dibersihkan
        ...
        <form @submit.prevent="submitOrder" class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input id="firstName" v-model="orderForm.firstName" type="text" required
            ...
            <div>
              ...
              <input id="lastName" v-model="orderForm.lastName" type="text" required
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input id="phone" v-model="orderForm.phone" type="tel" required
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
          </div>
          ...
          <div>
            ...
            <input id="address" v-model="orderForm.address" type="text" required
              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <input id="city" v-model="orderForm.city" type="text" required
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
            <div>
              ...
              <input id="state" v-model="orderForm.state" type="text" required
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
            <div>
              ...
              <input id="zipCode" v-model="orderForm.zipCode" type="text" required
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
            </div>
          </div>
          ...
          <div>
            ...
            <div class="space-y-3">
              <label class="flex items-center">
                <input v-model="orderForm.paymentMethod" type="radio" value="credit_card"
                  class="form-radio h-4 w-4 text-primary">
                <span class="ml-2">Credit Card</span>
              </label>
              <label class="flex items-center">
                <input v-model="orderForm.paymentMethod" type="radio" value="paypal"
                  class="form-radio h-4 w-4 text-primary">
                <span class="ml-2">PayPal</span>
              </label>
              <label class="flex items-center">
                <input v-model="orderForm.paymentMethod" type="radio" value="apple_pay"
                  class="form-radio h-4 w-4 text-primary">
